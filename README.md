...
| BE & FE | BE & FE | BE & FE |
| 프로젝트 일정 조율 <br> OpenAI API 연동 및 파싱 구현 <br> 프로젝트 생성 기능 구현 <br> 파일 기능 구현 <br> DB 설계 및 최적화 | 회의록 구현 <br> 보고서 구현 <br> 활동 기록(로그) 구현 <br> 알림 구현 <br> 팀매칭 구현 | 세션 및 인증 & 인가 <br> 프로필 구현 <br> 채팅 구현 <br> 캘린더 구현 <br> 팀매칭 구현 |
